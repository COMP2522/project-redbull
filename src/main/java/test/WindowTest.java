...
class WindowTest {
  ...
  void testGetWidth() {
    // We are using the min function that compares height and width and takes the lower value.
  ...
  void testGetOffset() {
    // We are using the min function that compares height and width
    // to find if the width or the height is smaller to get the correct offset.
